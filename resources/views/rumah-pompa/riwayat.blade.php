<x-layouts.app :title="'Riwayat Kartu Kendali — ' . $rumahPompa->barcode">
  <div class="mb-6">
    <a href="{{ route('rumah-pompa.index') }}" class="inline-flex items-center gap-2 text-gray-600 hover:text-gray-900 transition-colors mb-4">
    ...
    <p class="text-sm text-gray-600 mt-1">{{ $rumahPompa->barcode ?? $rumahPompa->serial_no }} - {{ $rumahPompa->location_code }}</p>
  </div>
