    ...
    <div class="max-w-7xl mx-auto px-4 py-6 space-y-6">
        ...
        <div class="space-y-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1
                        class="text-3xl font-bold tracking-tight bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-3 gap-4">
                <div
                    class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-500 to-indigo-600 p-5 shadow-lg hover:shadow-xl transition-all duration-300">
        ...
        @if(($rumahPompas ?? null) && $rumahPompas->count())
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                @foreach($rumahPompas as $rumahPompa)
                    ...
                    <div data-item data-serial="{{ $rumahPompa->serial_no }}" data-barcode="{{ $rumahPompa->barcode }}"
                        ...
                        <div class="p-6">
                            ...
                            <div class="relative mb-5">
                                ...
                                <div
                                    ...
                                    <div class="mb-3">
                                        <img src="{{ $rumahPompa->qr_url }}" alt="QR Rumah Pompa {{ $kodePendek }}"
                                    ...
                                    {{-- Download QR Button --}}
                                    <button onclick="downloadQR('{{ $rumahPompa->qr_url }}', 'QR_RumahPompa_{{ $kodePendek }}')"
        ...
        @else
            <div
                ...
                <div class="relative">
                    <div
                        class="w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-purple-500 to-indigo-600 flex items-center justify-center shadow-xl">
