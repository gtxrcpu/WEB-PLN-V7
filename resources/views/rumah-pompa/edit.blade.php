            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="name"
                           value="{{ old('name', $rumahPompa->name) }}"
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="zone"
                               value="{{ old('zone', $rumahPompa->zone) }}"
                    ...
                    <div>
                        ...
                        <select name="status"
                            ...
                            <option value="baik" {{ old('status', $rumahPompa->status) === 'baik' ? 'selected' : '' }}>Baik</option>
                            <option value="rusak" {{ old('status', $rumahPompa->status) === 'rusak' ? 'selected' : '' }}>Rusak</option>
                        </select>
                        @error('status')
                            <p class="mt-2 text-xs text-rose-600 flex items-center gap-1">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
