<x-layouts.app :title="'Riwayat Kartu Kendali — ' . $apar->barcode">
  <div class="mb-6">
  ...
  <div class="bg-white rounded-xl shadow-lg ring-1 ring-slate-200 p-6 mb-6">
    <div class="flex items-center justify-between mb-4">
      ...
      @if(request()->hasAny(['creator', 'approver', 'status']))
        <a href="{{ route('apar.riwayat', $apar->id) }}" 
    ...
    <form method="GET" action="{{ route('apar.riwayat', $apar->id) }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
      <div>
