          ...
          <div data-item 
            ...
            <div class="p-6">
              ...
              <div class="flex flex-col gap-2">
                ...
                <form method="POST" action="{{ route('admin.apab.destroy', $apab) }}" onsubmit="return confirm('Yakin ingin menghapus Apab {{ $apab->serial_no }}? Data yang terhapus tidak dapat dikembalikan!');" class="w-full">
                  @csrf
                  @method('DELETE')
