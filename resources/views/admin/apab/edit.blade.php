<x-layouts.app :title="'Edit Apab ' . ($apab->serial_no ?? '')">
<div class="max-w-4xl mx-auto px-4 py-6 space-y-6">
        ...
        <div class="relative flex items-start justify-between gap-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-cyan-100 text-sm">Perbarui informasi dan status Apab</p>
                </div>
            </div>
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-xl overflow-hidden">
        ...
        <form action="{{ route('admin.apab.update', $apab) }}" method="POST" class="p-8">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div class="relative">
                    ...
                    <p class="mt-2 text-xs text-slate-500 flex items-center gap-1.5">
                        ...
                        Serial tidak dapat diubah setelah Apab dibuat
                    </p>
                </div>
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="isi_apab"
                               ...
                               placeholder="Contoh: CO2, Foam, Dry Powder"
                               class="block w-full rounded-xl border-2 border-slate-200 text-slate-900 px-4 py-3 text-sm focus:border-cyan-500 focus:ring-4 focus:ring-cyan-500/10 transition-all @error('isi_apab') border-rose-500 focus:border-rose-500 focus:ring-rose-500/10 @enderror">
                        @error('isi_apab')
                            <p class="mt-2 text-xs text-rose-600 flex items-center gap-1">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        ...
                        @foreach([
                            ...
                            <label class="relative cursor-pointer group">
                                <input type="radio" name="status" value="{{ $value }}"
                                       {{ old('status', $apab->status) === $value ? 'checked' : '' }}
                                       class="peer sr-only">
                ...
                <div>
                    ...
                    <textarea name="notes" rows="4"
                              ...
                              class="block w-full rounded-xl border-2 border-slate-200 text-slate-900 px-4 py-3 text-sm focus:border-cyan-500 focus:ring-4 focus:ring-cyan-500/10 transition-all resize-none @error('notes') border-rose-500 focus:border-rose-500 focus:ring-rose-500/10 @enderror">{{ old('notes', $apab->notes) }}</textarea>
                    @error('notes')
                        <p class="mt-2 text-xs text-rose-600 flex items-center gap-1">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
