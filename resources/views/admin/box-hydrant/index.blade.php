<x-layouts.app :title="'Admin - Manage Box Hydrant'">
  <div class="max-w-7xl mx-auto px-4 py-6 space-y-6">
    ...
    <div class="space-y-6">
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p class="text-sm text-slate-600 mt-1">
            Kelola Box Hydrant dan pantau status setiap unit
          </p>
        </div>

        <div class="flex items-center gap-3">
          <a href="{{ route('admin.box-hydrant.create') }}"
      ...
      {{-- Stats Cards --}}
      @php
        $totalBoxHydrant = $boxHydrants->count();
        $statusBaik = $boxHydrants->where('status', 'baik')->count();
        $statusPerbaikan = $boxHydrants->where('status', 'perbaikan')->count();
        $statusRusak = $boxHydrants->where('status', 'rusak')->count();
      @endphp
    ...
    {{-- Grid Box Hydrant --}}
    @if($boxHydrants->count())
      <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        @foreach($boxHydrants as $boxHydrant)
          @php
            $serial = $boxHydrant->serial_no ?? '—';
            $kodePendek = $serial;
            ...
            <div class="p-6">
              ...
              <div class="mb-5">
                <div class="rounded-xl bg-slate-50 p-3 border border-slate-100">
                  <p class="text-xs text-slate-500 mb-1">Tipe Box Hydrant</p>
              ...
              <div class="flex flex-col gap-2">
                ...
                <a href="{{ route('admin.box-hydrant.edit', $boxHydrant) }}"
                ...
                <form method="POST" action="{{ route('admin.box-hydrant.destroy', $boxHydrant) }}" onsubmit="return confirm('Yakin ingin menghapus Box Hydrant {{ $boxHydrant->serial_no }}? Data yang terhapus tidak dboxHydrant dikembalikan!');" class="w-full">
                  @csrf
                  @method('DELETE')
      ...
      <div class="relative rounded-2xl border-2 border-dashed border-slate-300 p-12 text-center bg-gradient-to-br from-slate-50 to-white overflow-hidden">
        ...
        <div class="relative">
          ...
          <p class="text-slate-600 text-sm mb-6">
            Mulai kelola Box Hydrant dengan menambahkan unit pertama
          </p>
