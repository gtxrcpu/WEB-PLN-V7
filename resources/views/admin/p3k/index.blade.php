  ...
  <div class="max-w-7xl mx-auto px-4 py-6 space-y-6">
    ...
    <div class="space-y-6">
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p class="text-sm text-slate-600 mt-1">
            Kelola P3K (Pertolongan Pertama Pada Kecelakaan) dan pantau status setiap unit
          </p>
        </div>

        <div class="flex items-center gap-3">
          <a href="{{ route('admin.p3k.create') }}"
      ...
      @php
        ...
        $statusPerbaikan = $p3ks->where('status', 'perbaikan')->count();
            ...
            <div class="p-6">
              ...
              <div class="grid grid-cols-2 gap-3 mb-5">
                <div class="rounded-xl bg-slate-50 p-3 border border-slate-100">
                  ...
                  <p class="text-sm font-semibold text-slate-900">{{ $p3k->jenis ?? '—' }}</p>
                </div>
                <div class="rounded-xl bg-slate-50 p-3 border border-slate-100">
                  <p class="text-xs text-slate-500 mb-1">Kapasitas</p>
                  <p class="text-sm font-semibold text-slate-900">{{ $p3k->kapasitas ?? '—' }}</p>
                </div>
              </div>
              ...
              <div class="flex flex-col gap-2">
                ...
                <a href="{{ route('admin.p3k.edit', $p3k) }}"
                ...
                <form method="POST" action="{{ route('admin.p3k.destroy', $p3k) }}" onsubmit="return confirm('Yakin ingin menghapus APAT {{ $p3k->serial_no }}? Data yang terhapus tidak dp3k dikembalikan!');" class="w-full">
                  @csrf
                  @method('DELETE')
