<x-layouts.app :title="'Edit APAT ' . ($apat->serial_no ?? '')">
<div class="max-w-4xl mx-auto px-4 py-6 space-y-6">
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-xl overflow-hidden">
        ...
        <form action="{{ route('admin.apat.update', $apat) }}" method="POST" class="p-8">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="location"
                               value="{{ old('location', $apat->location) }}"
                ...
                <div>
                    ...
                    <input type="text" name="capacity"
                           value="{{ old('capacity', $apat->capacity) }}"
                        ...
                        @foreach([
                            ...
                            <label class="relative cursor-pointer group">
                                <input type="radio" name="status" value="{{ $value }}"
                                       {{ old('status', $apat->status) === $value ? 'checked' : '' }}
                                       class="peer sr-only">
