<x-layouts.app :title="'Upload Floor Plan — Admin'">
  <div class="mb-6">
    ...
    <h1 class="text-2xl font-bold text-gray-900">Upload Floor Plan</h1>
    <p class="text-sm text-gray-600 mt-1">Unggah denah gedung untuk unit tertentu</p>
  </div>

  <div class="bg-white rounded-xl shadow-lg ring-1 ring-slate-200 p-6">
    <form action="{{ route('admin.floor-plans.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6" x-data="floorPlanForm()">
      @csrf
      ...
      <div>
        <label class="block text-sm font-semibold text-gray-700 mb-2">Gambar Denah <span class="text-red-500">*</span></label>
          ...
          <div class="space-y-1 text-center">
            ...
            <div class="flex text-sm text-gray-600">
              <label for="image" class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                ...
                <input id="image" name="image" type="file" class="sr-only" accept="image/jpeg,image/png,image/jpg,image/svg+xml" required @change="previewImage">
              </label>
