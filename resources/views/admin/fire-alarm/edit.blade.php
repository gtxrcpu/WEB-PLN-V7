<x-layouts.app :title="'Edit Fire Alarm ' . ($fireAlarm->serial_no ?? '')">
<div class="max-w-4xl mx-auto px-4 py-6 space-y-6">
    {{-- Header Section --}}
    <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-red-600 via-orange-600 to-rose-600 p-8 shadow-xl">
        ...
        <div class="relative flex items-start justify-between gap-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-orange-100 text-sm">Perbarui informasi dan status Fire Alarm</p>
                </div>
            </div>
            <a href="{{ route('admin.fire-alarm.index') }}"
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-xl overflow-hidden">
        ...
        <form action="{{ route('admin.fire-alarm.update', $fireAlarm) }}" method="POST" class="p-8">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <div class="absolute right-3 top-1/2 -translate-y-1/2">
                            <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg bg-orange-100 text-orange-700 text-xs font-semibold">
                    ...
                    <p class="mt-2 text-xs text-slate-500 flex items-center gap-1.5">
                        ...
                        Serial tidak dapat diubah setelah Fire Alarm dibuat
                    </p>
                </div>
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="location_code"
                               ...
                               class="block w-full rounded-xl border-2 border-slate-200 text-slate-900 px-4 py-3 text-sm focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 transition-all @error('location_code') border-rose-500 focus:border-rose-500 focus:ring-rose-500/10 @enderror">
                        @error('location_code')
                    ...
                    <div>
                        ...
                        <input type="text" name="type"
                               ...
                               class="block w-full rounded-xl border-2 border-slate-200 text-slate-900 px-4 py-3 text-sm focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 transition-all @error('type') border-rose-500 focus:border-rose-500 focus:ring-rose-500/10 @enderror">
                        @error('type')
                            <p class="mt-2 text-xs text-rose-600 flex items-center gap-1">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        ...
                        @foreach([
                            ...
                            <label class="relative cursor-pointer group">
                                <input type="radio" name="status" value="{{ $value }}"
                                       {{ old('status', $fireAlarm->status) === $value ? 'checked' : '' }}
                                       class="peer sr-only">
                ...
                <div>
                    ...
                    <textarea name="notes" rows="4"
                              ...
                              class="block w-full rounded-xl border-2 border-slate-200 text-slate-900 px-4 py-3 text-sm focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 transition-all resize-none @error('notes') border-rose-500 focus:border-rose-500 focus:ring-rose-500/10 @enderror">{{ old('notes', $fireAlarm->notes) }}</textarea>
                    @error('notes')
                        <p class="mt-2 text-xs text-rose-600 flex items-center gap-1">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
