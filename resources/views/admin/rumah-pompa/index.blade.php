      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p class="text-sm text-slate-600 mt-1">
            Kelola Rumah Pompa dan pantau status setiap unit
          </p>
        </div>

        <div class="flex items-center gap-3">
          <a href="{{ route('admin.rumah-pompa.create') }}"
            ...
            <div class="p-6">
              ...
              <div class="grid grid-cols-2 gap-3 mb-5">
                ...
                <div class="rounded-xl bg-slate-50 p-3 border border-slate-100">
                  ...
                  <p class="text-sm font-semibold text-slate-900">{{ $rumahPompa->location_code ?? '—' }}</p>
                </div>
              </div>
              ...
              <div class="flex flex-col gap-2">
                ...
                <a href="{{ route('admin.rumah-pompa.edit', $rumahPompa) }}"
                ...
                <form method="POST" action="{{ route('admin.rumah-pompa.destroy', $rumahPompa) }}" onsubmit="return confirm('Yakin ingin menghapus Rumah Pompa {{ $rumahPompa->serial_no }}? Data yang terhapus tidak drumahPompa dikembalikan!');" class="w-full">
                  @csrf
                  @method('DELETE')
