          ...
          <div data-item 
            ...
            <div class="p-6">
              ...
              <div class="flex flex-col gap-2">
                ...
                <form method="POST" action="{{ route('admin.apar.destroy', $apar) }}" class="inline"
                      onsubmit="return confirm('Yakin ingin menghapus APAR ini?')">
                  @csrf
                  @method('DELETE')
                  <button type="submit"
                          class="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border-2 border-red-200 text-sm font-medium text-red-700 hover:bg-red-50 hover:border-red-300 transition-all duration-200">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
