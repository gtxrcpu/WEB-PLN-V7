          ...
          <div data-item 
            ...
            <div class="p-6">
              ...
              <div class="flex flex-col gap-2">
                ...
                <form method="POST" action="{{ route('admin.apat.destroy', $apat) }}" onsubmit="return confirm('Yakin ingin menghapus APAT {{ $apat->serial_no }}? Data yang terhapus tidak dapat dikembalikan!');" class="w-full">
                  @csrf
                  @method('DELETE')
