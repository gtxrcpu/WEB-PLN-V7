<x-layouts.app :title="'Pending Approvals — Leader'">
          ...
          @forelse($pendingApprovals as $kartu)
            <tr class="hover:bg-slate-50 transition-colors">
              ...
              <td class="px-6 py-4 text-right">
                <a href="{{ route('leader.approvals.show', $kartu->id) }}" 
                   class="inline-flex items-center gap-1 px-3 py-1.5 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors text-sm font-semibold">
