{{-- resources/views/box-hydrant/create.blade.php --}}
@extends('layouts.app')

@section('title', 'Tambah Box Hydrant')
...
<div class="max-w-4xl mx-auto px-4 py-6 space-y-6">
    ...
    <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-600 via-cyan-600 to-rose-600 p-8 shadow-xl">
        ...
        <div class="relative flex items-start justify-between gap-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-white mb-1">Tambah Box Hydrant Baru</h1>
                    <p class="text-cyan-100 text-sm">Input data Box, Hose, Nozzle. Serial & Barcode otomatis: <span class="font-semibold">H6.xxx</span></p>
                </div>
            </div>
    ...
    @php
        ...
        $nextSerial  = 'H6.' . str_pad($nextNumber, 3, '0', STR_PAD_LEFT);
        ...
        <div class="bg-gradient-to-r from-slate-50 to-slate-100 px-8 py-5 border-b border-slate-200">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-600">Lengkapi form di bawah untuk menambahkan Box Hydrant</p>
                </div>
            </div>
        </div>

        <form method="POST" action="{{ route('box-hydrant.store') }}" class="p-8">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="notes" rows="4"
                              ...
                              class="block w-full rounded-xl border-2 border-slate-200 text-slate-900 px-4 py-3 text-sm focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all resize-none @error('notes') border-rose-500 @enderror">{{ old('notes') }}</textarea>
                </div>
