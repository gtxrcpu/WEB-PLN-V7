...
<head>
    <meta charset="utf-8">
    <title>Kartu Kendali Box Hydrant - {{ $boxHydrant->barcode }}</title>
        ...
        <div class="mb-6 p-4 bg-slate-50 rounded-lg border border-slate-200">
            ...
            <div class="grid grid-cols-2 gap-x-6 gap-y-2 text-sm">
                <div>
                    ...
                    <span class="font-semibold ml-2">{{ $boxHydrant->name ?? '-' }}</span>
                </div>
                <div>
                    <span class="text-gray-600">No. Seri:</span>
                    <span class="font-semibold ml-2">{{ $boxHydrant->serial_no ?? '-' }}</span>
                </div>
                <div>
                    <span class="text-gray-600">Lokasi:</span>
                    <span class="font-semibold ml-2">{{ $boxHydrant->location_code ?? '-' }}</span>
                ...
                <div>
                    ...
                    <span class="font-semibold ml-2">{{ $boxHydrant->type ?? '-' }}</span>
                </div>
            </div>
        </div>
