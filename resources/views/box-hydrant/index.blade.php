    ...
    <div class="max-w-7xl mx-auto px-4 py-6 space-y-6">
        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-3 gap-4">
                <div
                    class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-500 to-red-600 p-5 shadow-lg hover:shadow-xl transition-all duration-300">
        ...
        @if(($boxHydrants ?? null) && $boxHydrants->count())
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                @foreach($boxHydrants as $boxHydrant)
                    ...
                    <div data-item data-serial="{{ $boxHydrant->serial_no }}" data-barcode="{{ $boxHydrant->barcode }}"
                        ...
                        <div class="p-6">
                            ...
                            <div class="relative mb-5">
                                ...
                                <div
                                    ...
                                    <div class="mb-3">
                                        <img src="{{ $boxHydrant->qr_url }}" alt="QR Box Hydrant {{ $kodePendek }}"
                                    ...
                                    {{-- Download QR Button --}}
                                    <button onclick="downloadQR('{{ $boxHydrant->qr_url }}', 'QR_BoxHydrant_{{ $kodePendek }}')"
