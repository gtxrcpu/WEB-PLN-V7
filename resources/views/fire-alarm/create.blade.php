{{-- resources/views/fire-alarm/create.blade.php --}}
@extends('layouts.app')

@section('title', 'Tambah Fire Alarm')
        ...
        <div class="bg-gradient-to-r from-slate-50 to-slate-100 px-8 py-5 border-b border-slate-200">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-600">Lengkapi form di bawah untuk menambahkan Fire Alarm</p>
                </div>
            </div>
        </div>

        <form method="POST" action="{{ route('fire-alarm.store') }}" class="p-8">
            @csrf
