    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-xl overflow-hidden">
        ...
        <form method="POST" action="{{ route('fire-alarm.update', $fireAlarm) }}" class="p-8">
            ...
            <div class="space-y-6">
                ...
                <x-floor-plan-picker 
                    :floor-plan-id="old('floor_plan_id', $fireAlarm->floor_plan_id)"
                    :floor-plan-x="old('floor_plan_x', $fireAlarm->floor_plan_x)"
                    :floor-plan-y="old('floor_plan_y', $fireAlarm->floor_plan_y)"
