<x-layouts.app :title="'Riwayat Kartu Kendali — ' . $fireAlarm->barcode">
  <div class="mb-6">
    <a href="{{ route('fire-alarm.index') }}" class="inline-flex items-center gap-2 text-gray-600 hover:text-gray-900 transition-colors mb-4">
    ...
    <p class="text-sm text-gray-600 mt-1">{{ $fireAlarm->barcode ?? $fireAlarm->serial_no }} - {{ $fireAlarm->location_code }}</p>
  </div>
          ...
          @forelse($riwayatInspeksi as $kartu)
            <tr class="hover:bg-slate-50 transition-colors">
              ...
              <td class="px-6 py-4 text-right">
                <a href="{{ route('fire-alarm.view-kartu', [$fireAlarm->id, $kartu->id]) }}" 
