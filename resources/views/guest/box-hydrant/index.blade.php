<x-guest.layouts.guest>
    <x-slot name="title">Box Hydrant - Guest Access</x-slot>
    ...
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        {{-- Navigation --}}
        <x-guest.navigation active="box-hydrant" />
        ...
        <div class="space-y-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p class="text-sm text-slate-600">
                        Pantau status dan riwayat inspeksi Box Hydrant
                    </p>
                </div>
            </div>
            ...
            {{-- Stats Cards --}}
            @php
                $totalBoxHydrant = $boxHydrants->total();
                        ...
                        <div class="p-6">
                            ...
                            <div class="grid grid-cols-2 gap-3 mb-5">
                                ...
                                <div class="rounded-xl bg-slate-50 p-3 border border-slate-100">
                                    ...
                                    <p class="text-sm font-semibold text-slate-900">{{ $boxHydrant->unit->name ?? '—' }}</p>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col gap-2">
                                <a href="{{ route('guest.box-hydrant.riwayat', $boxHydrant) }}"
            ...
            <div class="relative rounded-2xl border-2 border-dashed border-slate-300 p-12 text-center bg-gradient-to-br from-slate-50 to-white overflow-hidden">
                ...
                <div class="relative">
                    ...
                    <p class="text-slate-600 text-sm">
                        Tidak ada data Box Hydrant yang tersedia untuk dipantau
                    </p>
                </div>
            </div>
        @endif
