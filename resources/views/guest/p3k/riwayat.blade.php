<x-guest.layouts.guest>
    <x-slot name="title">Riwayat Kartu Kendali P3K - Guest Access</x-slot>
    ...
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="mb-6">
            ...
            <p class="text-sm text-gray-600">{{ $p3k->barcode ?? $p3k->serial_no }} - {{ $p3k->location_code }}</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg ring-1 ring-slate-200 p-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div class="rounded-xl bg-slate-50 p-4 border border-slate-100">
                    ...
                    <p class="text-sm font-semibold text-slate-900">{{ $p3k->serial_no ?? '—' }}</p>
                </div>
                <div class="rounded-xl bg-slate-50 p-4 border border-slate-100">
