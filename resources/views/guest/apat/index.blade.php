<x-guest.layouts.guest>
    <x-slot name="title">APAT - Guest Access</x-slot>
    ...
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        {{-- Navigation --}}
        <x-guest.navigation active="apat" />
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p class="text-sm text-slate-600">
                        Pantau status dan riwayat inspeksi APAT
                    </p>
                </div>
            </div>
                    ...
                    <div data-item 
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex flex-col gap-2">
                                <a href="{{ route('guest.apat.riwayat', $apat) }}"
            ...
            <div class="relative rounded-2xl border-2 border-dashed border-slate-300 p-12 text-center bg-gradient-to-br from-slate-50 to-white overflow-hidden">
                ...
                <div class="relative">
                    ...
                    <p class="text-slate-600 text-sm">
                        Tidak ada data APAT yang tersedia untuk dipantau
                    </p>
                </div>
            </div>
        @endif
