    ...
    <div class="max-w-7xl mx-auto px-4 py-6 space-y-6">
        ...
        <div class="space-y-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1
                        class="text-3xl font-bold tracking-tight bg-gradient-to-r from-red-600 to-orange-600 bg-clip-text text-transparent">
                        Manajemen APAB
                    </h1>
            ...
            <div class="grid grid-cols-2 lg:grid-cols-3 gap-4">
                <div
                    class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-red-500 to-orange-600 p-5 shadow-lg hover:shadow-xl transition-all duration-300">
                        ...
                        <div class="p-6">
                            ...
                            <div class="relative mb-5">
                                ...
                                <div
                                    ...
                                    {{-- Download QR Button --}}
                                    <button onclick="downloadQR('{{ $apab->qr_url }}', 'QR_APAB_{{ $kodePendek }}')"
        ...
        @else
            <div
                ...
                <div class="relative">
                    <div
                        class="w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-red-500 to-orange-500 flex items-center justify-center shadow-xl">
