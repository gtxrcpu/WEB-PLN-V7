  ...
  <div class="max-w-7xl mx-auto px-4 py-6 space-y-6">
    ...
    <div class="space-y-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h1 class="text-3xl font-bold tracking-tight bg-gradient-to-r from-cyan-600 to-sky-600 bg-clip-text text-transparent">
                    Manajemen APAT
                </h1>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-3 gap-4">
            <div class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-cyan-500 to-cyan-600 p-5 shadow-lg hover:shadow-xl transition-all duration-300">
    ...
    @if(($apats ?? null) && $apats->count())
      <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        @foreach($apats as $apat)
          ...
          <div data-item 
               data-serial="{{ $apat->serial_no }}" 
               data-location="{{ $apat->lokasi }}"
            ...
            <div class="p-6">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <a href="{{ route('apat.riwayat', $apat) }}"
                       class="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border-2 border-cyan-200 bg-cyan-50 text-sm font-medium text-cyan-700 hover:bg-cyan-100 hover:border-cyan-300 transition-all duration-200">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
